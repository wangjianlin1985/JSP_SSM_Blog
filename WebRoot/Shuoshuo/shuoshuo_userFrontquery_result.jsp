...
<%
    ...
    String shuoshuoContent = (String)request.getAttribute("shuoshuoContent"); //日志内容查询关键字
...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>Shuoshuo/frontlist">日志信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="<%=basePath %>Shuoshuo/shuoshuo_frontAdd.jsp" style="display:none;">添加日志</a>
		</ul>
		<div class="row">
			<%
				/*计算起始序号*/
				...
				for(int i=0;i<shuoshuoList.size();i++) {
            		...
            		Shuoshuo shuoshuo = shuoshuoList.get(i); //获取到日志对象
            		String clearLeft = "";
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>Shuoshuo/<%=shuoshuo.getShuoshuoId() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=shuoshuo.getPhoto1()%>" /></a>
			     <div class="showFields">
			     	...
			     	<div class="field">
	            		日志内容:<%=shuoshuo.getShuoshuoContent() %>
			     	</div>
			        ...
			        <a class="btn btn-primary top5" onclick="shuoshuoDelete('<%=shuoshuo.getShuoshuoId() %>');">删除</a>
			     </div>
			</div>
			<%  } %>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="shuoshuoQueryForm" id="shuoshuoQueryForm" action="<%=basePath %>Shuoshuo/userFrontlist" class="mar_t15" method="post">
			<div class="form-group">
				<label for="shuoshuoContent">日志内容:</label>
				<input type="text" id="shuoshuoContent" name="shuoshuoContent" value="<%=shuoshuoContent %>" class="form-control" placeholder="请输入日志内容">
			</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;日志信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="shuoshuo_shuoshuoId_edit" class="col-md-3 text-right">日志id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="shuoshuo_shuoshuoId_edit" name="shuoshuo.shuoshuoId" class="form-control" placeholder="请输入日志id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  	 <label for="shuoshuo_shuoshuoContent_edit" class="col-md-3 text-right">日志内容:</label>
		  	 <div class="col-md-9">
			    <textarea id="shuoshuo_shuoshuoContent_edit" name="shuoshuo.shuoshuoContent" rows="8" class="form-control" placeholder="请输入日志内容"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
