...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>PostInfo/frontlist">博文信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">博文id:</div>
		<div class="col-md-10 col-xs-6"><%=postInfo.getPostInfoId()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">博文标题:</div>
		<div class="col-md-10 col-xs-6"><%=postInfo.getTitle()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">博文图片:</div>
		<div class="col-md-10 col-xs-6"><img class="img-responsive" src="<%=basePath %><%=postInfo.getPostPhoto() %>"  border="0px"/></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">博文内容:</div>
