...
<%
    ...
    String title = (String)request.getAttribute("title"); //博文标题查询关键字
...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>PostInfo/frontlist">博文信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="<%=basePath %>PostInfo/postInfo_frontAdd.jsp" style="display:none;">添加博文</a>
		</ul>
		<div class="row">
			<%
				/*计算起始序号*/
				...
				for(int i=0;i<postInfoList.size();i++) {
            		...
            		PostInfo postInfo = postInfoList.get(i); //获取到博文对象
            		String clearLeft = "";
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>PostInfo/<%=postInfo.getPostInfoId() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=postInfo.getPostPhoto()%>" /></a>
			     <div class="showFields">
			        ...
			        <a class="btn btn-primary top5" onclick="postInfoDelete('<%=postInfo.getPostInfoId() %>');">删除</a>
			     </div>
			</div>
			<%  } %>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="postInfoQueryForm" id="postInfoQueryForm" action="<%=basePath %>PostInfo/userFrontlist" class="mar_t15" method="post">
			<div class="form-group">
				<label for="title">博文标题:</label>
				<input type="text" id="title" name="title" value="<%=title %>" class="form-control" placeholder="请输入博文标题">
			</div>
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;博文信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="postInfo_postInfoId_edit" class="col-md-3 text-right">博文id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="postInfo_postInfoId_edit" name="postInfo.postInfoId" class="form-control" placeholder="请输入博文id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  	 <label for="postInfo_title_edit" class="col-md-3 text-right">博文标题:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="postInfo_title_edit" name="postInfo.title" class="form-control" placeholder="请输入博文标题">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="postInfo_postPhoto_edit" class="col-md-3 text-right">博文图片:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="postInfo_content_edit" class="col-md-3 text-right">博文内容:</label>
		  	 <div class="col-md-9">
...
<script>
//实例化编辑器
var postInfo_content_edit = UE.getEditor('postInfo_content_edit'); //博文内容编辑器
