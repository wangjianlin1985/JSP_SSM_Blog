...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">博客</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>UserInfo/frontlist">博友风采</a></li>
                <li><a href="<%=basePath %>PostInfo/frontlist">博文</a></li>
                <!-- 
                <li><a href="<%=basePath %>Reply/frontlist">博文回复</a></li> 
                <li><a href="<%=basePath %>ZanInfo/frontlist">博文点赞</a></li>
                <li><a href="<%=basePath %>Comment/frontlist">日志评论</a></li>
                <li><a href="<%=basePath %>ShuoshuoZan/frontlist">日志点赞</a></li>
                -->
                <li><a href="<%=basePath %>Shuoshuo/frontlist">日志</a></li> 
                
                <li><a href="<%=basePath %>Guanzhu/frontlist">关注</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>PostInfo/postInfo_frontUserAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发布博文</a></li>
                        <li><a href="<%=basePath %>PostInfo/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我发布的博文</a></li>
                        <li><a href="<%=basePath %>Shuoshuo/shuoshuo_frontUserAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发布日志</a></li>
                        <li><a href="<%=basePath %>Shuoshuo/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我发布的日志</a></li>
                        <li><a href="<%=basePath %>Guanzhu/userFrontlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我关注的人</a></li>
