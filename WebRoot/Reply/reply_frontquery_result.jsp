		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#replyListPanel" aria-controls="replyListPanel" role="tab" data-toggle="tab">博文回复列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>Reply/reply_frontAdd.jsp" style="display:none;">添加博文回复</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>回复id</td><td>被回博文</td><td>回复内容</td><td>回复人</td><td>回复时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<replyList.size();i++) {
					    	            		...
					    	            		Reply reply = replyList.get(i); //获取到博文回复对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="replyQueryForm" id="replyQueryForm" action="<%=basePath %>Reply/frontlist" class="mar_t15" method="post">
            <div class="form-group">
            	<label for="postInfoObj_postInfoId">被回博文：</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;博文回复信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="reply_postInfoObj_postInfoId_edit" class="col-md-3 text-right">被回博文:</label>
		  	 <div class="col-md-9">
