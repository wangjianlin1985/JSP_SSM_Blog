			       ...
			       children:
			    	   [{
			    	    ...
			    	    },
			    	    {
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "ZanInfo/zanInfo_add.jsp"
			    	   	},
			    		{
			    	   		text: "博文点赞管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "ZanInfo/zanInfo_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "日志评论点赞管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Shuoshuo/shuoshuo_add.jsp"
			    	   	},
			    		{
			    	   		text: "日志管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Shuoshuo/shuoshuo_query_result.jsp"
			    	    },
			    	    {
			    		    text: "添加日志评论",
			    		    state: "open",
			    	    ...
			    	    },
			    	    {
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "ShuoshuoZan/shuoshuoZan_add.jsp"
			    	   	},
			    		{
			    	   		text: "日志点赞管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "ShuoshuoZan/shuoshuoZan_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "用户关注管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Guanzhu/guanzhu_add.jsp"
			    	   	},
			    		{
			    	   		text: "用户关注管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Guanzhu/guanzhu_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "留言管理",
