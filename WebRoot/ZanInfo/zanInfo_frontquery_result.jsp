		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#zanInfoListPanel" aria-controls="zanInfoListPanel" role="tab" data-toggle="tab">博文点赞列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>ZanInfo/zanInfo_frontAdd.jsp" style="display:none;">添加博文点赞</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>点赞id</td><td>被点赞博文</td><td>点赞人</td><td>点赞时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<zanInfoList.size();i++) {
					    	            		...
					    	            		ZanInfo zanInfo = zanInfoList.get(i); //获取到博文点赞对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="zanInfoQueryForm" id="zanInfoQueryForm" action="<%=basePath %>ZanInfo/frontlist" class="mar_t15" method="post">
            <div class="form-group">
            	<label for="postObj_postInfoId">被点赞博文：</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;博文点赞信息编辑</h4>
      </div>
