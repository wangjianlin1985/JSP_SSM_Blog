		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group" style="display:none;">
				  	 <label for="userInfo_shzt" class="col-md-2 text-right">审核状态:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="userInfo_shzt" name="userInfo.shzt" value="待审核" class="form-control" placeholder="请输入审核状态">
					 </div>
				  </div>
				  <div class="form-group" style="display:none;">
