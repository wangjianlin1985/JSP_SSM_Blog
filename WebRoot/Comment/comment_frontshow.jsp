...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>Comment/frontlist">日志评论信息</a></li>
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">被评日志:</div>
		<div class="col-md-10 col-xs-6"><%=comment.getShuoshuoObj().getShuoshuoContent() %></div>
	</div>
	<div class="row bottom15"> 
