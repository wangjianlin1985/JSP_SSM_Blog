		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#commentListPanel" aria-controls="commentListPanel" role="tab" data-toggle="tab">日志评论列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>Comment/comment_frontAdd.jsp" style="display:none;">添加日志评论</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>评论id</td><td>被评日志</td><td>评论内容</td><td>评论人</td><td>评论时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<commentList.size();i++) {
					    	            		...
					    	            		Comment comment = commentList.get(i); //获取到日志评论对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
 											<td><%=comment.getCommentId() %></td>
 											<td><%=comment.getShuoshuoObj().getShuoshuoContent() %></td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="commentQueryForm" id="commentQueryForm" action="<%=basePath %>Comment/frontlist" class="mar_t15" method="post">
            <div class="form-group">
            	<label for="shuoshuoObj_shuoshuoId">被评日志：</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;日志评论信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="comment_shuoshuoObj_shuoshuoId_edit" class="col-md-3 text-right">被评日志:</label>
		  	 <div class="col-md-9">
			    <select id="comment_shuoshuoObj_shuoshuoId_edit" name="comment.shuoshuoObj.shuoshuoId" class="form-control">
			    </select>
		  	 </div>
		  </div>
		  <div class="form-group">
		  	 ...
		  	 <div class="col-md-9">
			    <textarea id="comment_commentContent_edit" name="comment.commentContent" rows="8" class="form-control" placeholder="请输入评论内容"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
			...
			if (comment) {
				...
				$.ajax({
					...
					success: function(shuoshuos,response,status) { 
						$("#comment_shuoshuoObj_shuoshuoId_edit").empty();
						var html="";
		        		$(shuoshuos).each(function(i,shuoshuo){
		        			html += "<option value='" + shuoshuo.shuoshuoId + "'>" + shuoshuo.shuoshuoContent + "</option>";
		        		});
		        		$("#comment_shuoshuoObj_shuoshuoId_edit").html(html);
		        		$("#comment_shuoshuoObj_shuoshuoId_edit").val(comment.shuoshuoObjPri);
					}
				});
