...
public class CommentService {
    ...
    /*按照查询条件分页查询日志评论记录*/
    public ArrayList<Comment> queryComment(Shuoshuo shuoshuoObj,UserInfo userObj,String commentTime,int currentPage) throws Exception { 
     	String where = "where 1=1";
    	if(null != shuoshuoObj && shuoshuoObj.getShuoshuoId()!= null && shuoshuoObj.getShuoshuoId()!= 0)  where += " and t_comment.shuoshuoObj=" + shuoshuoObj.getShuoshuoId();
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Comment> queryComment(Shuoshuo shuoshuoObj,UserInfo userObj,String commentTime) throws Exception  { 
     	String where = "where 1=1";
    	if(null != shuoshuoObj && shuoshuoObj.getShuoshuoId()!= null && shuoshuoObj.getShuoshuoId()!= 0)  where += " and t_comment.shuoshuoObj=" + shuoshuoObj.getShuoshuoId();
    	if(null != userObj &&  userObj.getUser_name() != null && !userObj.getUser_name().equals(""))  where += " and t_comment.userObj='" + userObj.getUser_name() + "'";
    	if(!commentTime.equals("")) where = where + " and t_comment.commentTime like '%" + commentTime + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(Shuoshuo shuoshuoObj,UserInfo userObj,String commentTime) throws Exception {
     	String where = "where 1=1";
    	if(null != shuoshuoObj && shuoshuoObj.getShuoshuoId()!= null && shuoshuoObj.getShuoshuoId()!= 0)  where += " and t_comment.shuoshuoObj=" + shuoshuoObj.getShuoshuoId();
    	if(null != userObj &&  userObj.getUser_name() != null && !userObj.getUser_name().equals(""))  where += " and t_comment.userObj='" + userObj.getUser_name() + "'";
    	if(!commentTime.equals("")) where = where + " and t_comment.commentTime like '%" + commentTime + "%'";
